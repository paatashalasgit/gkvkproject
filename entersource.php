  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <form id="sourceentryform" name="sourceentryform" action="dataentry.php" method="post">    
            <div class="row">
                <div class= "col-lg-3 col-sm-12">
                    <div class="form-group">
                        ...
                        <?php 
                            $result = mysql_query("select max(source_entry_id), resource_name from source_entry");
                            list($id,$resourcename)=mysql_fetch_array($result);
                            $id= $id +1;
                        ?>
                        <input type="text" name="papernumber" id="papernumber" class="form-control"  value= "<?php echo $id ?>"  readonly="readonly">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="crop" id="crop" style="width: 100%;">
                                ...
                                <?php
                                    ...
                                    $r1 = mysql_query("select distinct resource_name from  resource_crop order by  resource_name asc", $connection);
            ...
            <div class="row ">
                <div class="col-lg-12 col-sm-12">
                    <label>Title</label>
                    <textarea rows="2" type="text" name="title" id="title" class="form-control" > </textarea>
            ...
            <div class="row ">
                <div class="col-lg-12 col-sm-12">
                    <label>Author</label>
                    <textarea rows="2" type="text" name="author" id="author" class="form-control" > </textarea>
            ...
            <div class="row ">
                <div class="col-lg-12 col-sm-12">
                    <label>Journal</label>
                    <textarea rows="2" type="text" name="journal" id="journal" class="form-control" > </textarea>
            ...
            <input type="submit" class="btn btn-primary" name="submit_entersource" id="submit_entersource" value="Next">
