  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <form id="sourceentryform" name="sourceentryform" action="edit_dataentry.php" method="post">    
            <div class="row">
            ...
            <input type="submit" class="btn btn-primary" name="submit_editsource" id="submit_editsource" value="Next">
