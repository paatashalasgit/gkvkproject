                                ...
                                while(list($introimage)=mysql_fetch_array($rim))
								{
								    ...
								    ?>
								        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-2">
								            <div><a href = ""><img src="<?php echo $introimage; ?>" alt="Image not Uploaded" height="50" width="50" name="introimage" id="introimage" /></a><a href="javascript:;" onclick='deleteintroimage("<?php echo $introimage; ?>")'>Remove</a></div>
								        </div>
								    <?php
                        ...
                        <label for="exampleInputPassword1">Upload Images</label>
            				...
            				<tbody id="introtableattachtbody">
            					<tr class="add_row">
            						...
            						<td width="20%"><img src="" alt="Image not Selected" height="50" width="50" name="introimage[]" onerror="this.style.display='none'" /></td>
            						<td width="20%"></td>
            					</tr>
            				</tbody>
            				<tfoot>
                        ...
                        <label for="exampleInputPassword1">Symptoms</label>
                            <table class="table table-bordered" id="symptoms">
                                ...
                                while(list($symptomsimage)=mysql_fetch_array($r_si))
								{
								    ...
								    ?>
								        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-2">
								            <div><a href = ""><img src="<?php echo $symptomsimage; ?>" alt="Image not Uploaded" height="50" width="50" name="symptomsimage" id="symptomsimage" /></a><a href="javascript:;" onclick='deletesymptomsimage("<?php echo $symptomsimage; ?>")'>Remove</a></div>
								        </div>
								    <?php
                ...
                <!--<h3 class="">Life Cycle & Ecology</h3>-->
                        ...
                        <div class="row ">
                                ...
                                while(list($leimage)=mysql_fetch_array($rle))
								{
								    ...
								    ?>
								        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-2">
								            <div><a href = ""><img src="<?php echo $leimage; ?>" alt="Image not Uploaded" height="50" width="50" name="leimage" id="leimage" /></a><a href="javascript:;" onclick='deletelifecycleimage("<?php echo $leimage; ?>")'>Remove</a></div>
								        </div>
								    <?php
...
<script>
		...
		$(document).ready(function(){
			...
			$('#introtableattach').on('click', "#add", function(e) {
			    console.log('Add new attachment row Intro');
