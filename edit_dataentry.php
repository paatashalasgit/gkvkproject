...
if(isset($_POST['submit_editsource']))
{   
    ...
    $q1 = "update source_entry set resource_name = '$resource_name',title =  '$title',author = '$author',journal = '$journal',issue = '$issue',volume = '$volume', page = '$page',year = '$year',url = '$url',email = '$email', last_modified = '$last_modified' where paper_no = '$paper_no'";
    ...
    // echo "<script>alert($q1)</script>";
     ...
     $q_sourceentryid = "select source_entry_id from source_entry where paper_no = '$paper_no' ";
    $r_sourceentryid = mysql_query($q_sourceentryid);
    list($source_entry_id) = mysql_fetch_row($r_sourceentryid);
    
    $_SESSION['edit_source_entry_id'] = $source_entry_id;
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Data Entry</li>
      </ol>
    </section>
    ...
    <section class="content">
	  ...
	  <form action="edit_dataentrydone.php" method="post"  enctype="multipart/form-data">    
      <div class="box box-default">
        <div class="box-header with-border">
          <h2 class="box-title">Edit Data Entry Form</h2>
        ...
        <div class="box-body">
                ...
                <div class= "col-lg-3 col-sm-12">
                    <div class="form-group">
                        ...
                        <input list="selectgenus" name="select-genus" id="select-genus" class="form-control select2" style="width: 100%;" onkeyup="dropDown(this.value,'selectgenus')" value="<?php echo $genus ?>">
                ...
                <div class= "col-lg-3 col-sm-12">
                    <div class="form-group">
                        ...
                        <input list="st" name="s-t" id="s-t" class="form-control select2" style="width: 100%;" onkeyup="dropDown(this.value,'st')" value="<?php echo $type ?>" >
                                <datalist id="st" >
            ...
            <div class="row ">
                <div class="col-lg-6 col-sm-12">
                    <label for="">Select Species</label>
                        <input list="select-species" name="selectspecies" id="selectspecies" class="form-control select2" style="width: 100%;" onkeyup="dropDown(this.value,'select-species')" value="<?php echo $species ?>">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                        ...
                                        <?php
                                            ...
                                            while(list($world_distribution) = mysql_fetch_array($r7))
                                            {
                                                ...
                                                "
                                                    ...
                                                    <td>
                                                        <input type='text'  name='worlddistribution_world[]' id='worlddistribution_world1[]' class='form-control select2' value='".$world_distribution."' >
                                ...
                                <INPUT type="button" value="Add Row" onclick="placeRow('modify-worlddistribution','clone-worlddistribution','worlddistribution')" />
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                            ...
                                            while(list($india_distribution) = mysql_fetch_array($r8))
                                            {
                                                ...
                                                "
                                                    <tr id='clone-indiadistribution'>
                                                        ...
                                                        <td>
                                                            <input type='text' name='indiadistribution_states[]' id='indiadistribution_states1[]' class='form-control select2' value='".$india_distribution."' >
                                ...
                                <INPUT type="button" value="Add Row" onclick="placeRow('modify-indiadistribution','clone-indiadistribution','indiadistribution')" />
                            </div>
                        </div>
                ...
                <div class="row ">
                    <div class="col-lg-6 col-sm-12">
                        <label for="exampleInputPassword1">Stage of Pests Attacked</label>
                            <input list="stageofpest-sattacked" name="stageofpests_attacked" id="stageofpests_attacked" class="form-control select2" onkeyup="dropDown(this.value,'stageofpests-attacked')" value="<?php echo $stage_pest_attack ;  ?>">
                                ...
                                while(list($introimage)=mysql_fetch_array($rim))
								{
								    ...
								    ?>
								        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-2">
								            <div><a href = ""><img src="<?php echo $introimage; ?>" onerror="this.style.display='none'" alt="Image not Uploaded" height="50" width="50" name="introimage" id="introimage" /></a><a href="javascript:;" onclick='deleteintroimage("<?php echo $introimage; ?>")'>Remove</a></div>
								        </div>
								    <?php
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <label for="exampleInputPassword1">Upload Images</label>
            				...
            				<tbody id="introtableattachtbody">
            					<!--<tr class="add_row">-->
            					<!--	<td width="60%"><input class="file" name='introfiles[]' id='introfiles[]' type='file'/></td>-->
            					<!--	<td width="20%"><img src=""  height="50" width="50" name="introimage[]"  onerror="this.style.display='none'"></td>-->
            					<!--	<td width="20%"></td>-->
            					<!--</tr>-->
            				</tbody>
            				<tfoot>
                        ...
                        <label for="exampleInputPassword1">Symptoms</label>
                            <table class="table table-bordered" id="symptoms">
                                ...
                                while(list($symptomsimage)=mysql_fetch_array($r_si))
								{
								    ...
								    ?>
								        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-2">
								            <div><a href = ""><img src="<?php echo $symptomsimage; ?>" onerror="this.style.display='none'" alt="Image not Uploaded" height="50" width="50" name="symptomsimage" id="symptomsimage" /></a><a href="javascript:;" onclick='deletesymptomsimage("<?php echo $symptomsimage; ?>")'>Remove</a></div>
								        </div>
								    <?php
                ...
                <div class="row ">
                    <div class="col-lg-6 col-sm-12">
                        <label for="exampleInputPassword1">Upload Images</label>
                            <!--<input type="file" name="introduction_image[]" id="introduction_image" multiple="multiple">-->
                            <!--<input type="submit" value="Upload Image" name="submit">                    -->
                            <table id="symptomstableattach" class="table table-bordered" width="50%">
            				<!--<thead>
            					<tr class="text-center">
            						<th colspan="3" style="height:50px;">Mutiple File Upload Script</th>	
            					</tr>
            				</thead>-->
            				<tbody id="symptomstableattachtbody">
            					<!--<tr class="add_row">-->
            					<!--	<td width="60%"><input class="file" name='symptomsfiles[]' id='symptomsfiles[]' type='file'/></td>-->
            					<!--	<td width="20%"><img src="" alt="Image not Selected" height="50" width="50" name="symptomsimage[]" onerror="this.style.display='none'" /></td>-->
            					<!--	<td width="20%"></td>-->
            					<!--</tr>-->
            				</tbody>
            				<tfoot>
                ...
                <!--<h3 class="">Life Cycle & Ecology</h3>-->
                        ...
                        <div class="row ">
                                ...
                                while(list($leimage)=mysql_fetch_array($rle))
								{
								    ...
								    ?>
								        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-2">
								            <div><a href = ""><img src="<?php echo $leimage; ?>" onerror="this.style.display='none'" alt="Image not Uploaded" height="50" width="50" name="leimage" id="leimage" /></a><a href="javascript:;" onclick='deletelifecycleimage("<?php echo $leimage; ?>")'>Remove</a></div>
								        </div>
								    <?php
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <label for="exampleInputPassword1">Upload Images</label>
                            <!--<input type="file" name="introduction_image[]" id="introduction_image" multiple="multiple">-->
                            <!--<input type="submit" value="Upload Image" name="submit">                    -->
                            <table id="lifecycletableattach" class="table table-bordered" width="50%">
            				<!--<thead>
            					<tr class="text-center">
            						<th colspan="3" style="height:50px;">Mutiple File Upload Script</th>	
            					</tr>
            				</thead>-->
            				<tbody id="lifecycletableattachtbody">
            					<!--<tr class="add_row">-->
            					<!--	<td width="60%"><input class="file" name='lifecyclefiles[]' id='lifecyclefiles[]' type='file'/></td>-->
            					<!--	<td width="20%"><img src="" alt="Image not Selected" height="50" width="50" name="lifecycleimage[]" onerror="this.style.display='none'" /></td>-->
            					<!--	<td width="20%"></td>-->
            					<!--</tr>-->
            				</tbody>
            				<tfoot>
      ...
      <div name="deleteimages" id = "deleteimages">
        <input type="hidden" name="lifecycleimagestodelete[]" id="lifecycleimagestodelete[]" >
        <input type="hidden" name="introimagestodelete[]" id="introimagestodelete[]" >
        <input type="hidden" name="symptomsimagestodelete[]" id="symptomsimagestodelete[]" >
      </div>
        <!-- /.modal -->
...
<script>
    ...
    function cloneRow(tbId,trId) {
     ...
     var len = clone.children.length;
      console.log("in clone row 1 "+len);
      for(var i=0; i<len; i++) {
            var len1 = clone.children[i].children.length;
            console.log("in clone row 2 "+len1);
            for(var j=0; j<len1; j++) {
                console.log("in clone row 3");
                if(clone.children[i].children[j].type == "text") {
                    clone.children[i].children[j].value = "";
                    console.log("value nulled");
                }
            }
      }    
...
<script>
    ...
    function placeRow(tbId,trId,tableid) {
    ...
    //     var delCell = clone.insertCell();
    //   delCell.innerHTML = '<button type="button" class="btn btn-block btn-danger" onclick="delRow(this,\'' + tableid + '\')"><i class="fa fa-fw fa-close"></i></button>';
      clone.id = trId;  // change id or other attributes/contents
      var world_placeinput = document.getElementsByName('worlddistribution_world[]');
      
      table.appendChild(clone); // add new row to end of table
       console.log(world_placeinput.length);
       for(var i = 0; i < world_placeinput.length; i++){
           //var world_input_id = "worlddistribution_autocomplete[" + i + "]";
            //console.log(world_input_id);
            //var world_input = document.getElementById("'"+world_input_id+"'");
            //console.log(world_input.value());
     
      var autocomplete = new google.maps.places.Autocomplete(world_placeinput[i],
      {
          types: ['(regions)']
      ...
      google.maps.event.addListener(autocomplete, 'place_changed', function () {
        ...
        document.getElementsByName('worlddistribution_world[i]').innerHTML = near_place.formatted_address;

        });
           
       }
       
       var india_placeinput = document.getElementsByName('indiadistribution_states[]');
       
        for(var i = 0; i < india_placeinput.length; i++){
           //var world_input_id = "worlddistribution_autocomplete[" + i + "]";
            //console.log(world_input_id);
            //var world_input = document.getElementById("'"+world_input_id+"'");
            //console.log(world_input.value());
     
      var autocomplete = new google.maps.places.Autocomplete(india_placeinput[i],
      {
          types: ['(regions)'],
...
<script>
     ...
     $(document).ready(function () {    
      var world_input = document.getElementById('worlddistribution_world1');
      var india_input = document.getElementById('indiadistribution_states1');
        
    console.log(world_input.length);     
...
<script>
		...
		$(document).ready(function(){
			...
			$('#introtableattach').on('click', "#add", function(e) {
			    ...
			    $('#introtableattachtbody').append('<tr class="add_row"><td><input name="introfiles[]" type="file"/></td><td><img src="" alt="Image not Uploaded" height="50" width="50" name="introimage[]" onerror="this.style.display=\'none\'" /></td><td class="text-center"><button type="button" class="btn btn-danger btn-sm" id="delete" title="Delete file">Delete file</button></td><tr>');
				e.preventDefault();
				var filecount = document.getElementsByName("introfiles[]").length-1;
				introFilesOnchange(filecount);
			});
		...
		introFilesOnchange(0);
		function introFilesOnchange(filecount) {
		
		    //alert("Hello! I am an alert box!!");
		    
		    //var filecount = document.getElementsByName("introfiles[]").length;
		    
		    document.getElementsByName("introfiles[]")[filecount].onchange = function () {
    		    //document.getElementsByName("introimage[]")[filecount].src = document.getElementsByName("introfiles[]")[filecount].value;
            var reader = new FileReader();
            reader.onload = function (e) {
                // get loaded data and render thumbnail.
                    document.getElementsByName("introimage[]")[filecount].src = e.target.result;
                    document.getElementsByName("introimage[]")[filecount].style.display = "block";
            };
...
<script>
		...
		$(document).ready(function(){
			...
			// Append new row
			$('#lifecycletableattach').on('click', "#add", function(e) {
				$('#lifecycletableattachtbody').append('<tr class="add_row"><td><input name="lifecyclefiles[]" type="file"/></td><td><img src="" alt="Image not Uploaded" height="50" width="50" name="lifecycleimage[]" onerror="this.style.display=\'none\'" /></td><td class="text-center"><button type="button" class="btn btn-danger btn-sm" id="delete" title="Delete file">Delete file</button></td><tr>');
				e.preventDefault();
				var filecount = document.getElementsByName("lifecyclefiles[]").length-1;
				lifecycleFilesOnchange(filecount);
			});
			
			// Delete row
			$('#lifecycletableattach').on('click', "#delete", function(e) {
				if (!confirm("Are you sure you want to delete this file?"))
				return false;
				$(this).closest('tr').remove();
				e.preventDefault();
				lifecycleFilesOnchange();
			});
		});
		
		lifecycleFilesOnchange(0);
		function lifecycleFilesOnchange(filecount) {
		
		    //alert("Hello! I am an alert box!!");
		    
		    //var filecount = document.getElementsByName("lifecyclefiles[]").length;
		    
		    document.getElementsByName("lifecyclefiles[]")[filecount].onchange = function () {
    		    //document.getElementsByName("introimage[]")[filecount].src = document.getElementsByName("introfiles[]")[filecount].value;
            var reader = new FileReader();
            reader.onload = function (e) {
                // get loaded data and render thumbnail.
                    document.getElementsByName("lifecycleimage[]")[filecount].src = e.target.result;
                     document.getElementsByName("lifecycleimage[]")[filecount].style.display = "block";
            };
...
<script>
		...
		$(document).ready(function(){
			...
			// Append new row
			$('#symptomstableattach').on('click', "#add", function(e) {
				$('#symptomstableattachtbody').append('<tr class="add_row"><td><input name="symptomsfiles[]" type="file"/></td><td><img src="" alt="Image not Uploaded" height="50" width="50" name="symptomsimage[]" onerror="this.style.display=\'none\'" /></td><td class="text-center"><button type="button" class="btn btn-danger btn-sm" id="delete" title="Delete file">Delete file</button></td><tr>');
				e.preventDefault();
				var filecount = document.getElementsByName("symptomsfiles[]").length-1;
				symptomsFilesOnchange(filecount);
			});
			
			// Delete row
			$('#symptomstableattach').on('click', "#delete", function(e) {
				if (!confirm("Are you sure you want to delete this file?"))
				return false;
				$(this).closest('tr').remove();
				e.preventDefault();
				symptomsFilesOnchange();
			});
		});
		
		symptomsFilesOnchange(0);
		function symptomsFilesOnchange(filecount) {
		
		    //alert("Hello! I am an alert box!!");
		    
		    //var filecount = document.getElementsByName("introfiles[]").length;
		    
		    document.getElementsByName("symptomsfiles[]")[filecount].onchange = function () {
    		    //document.getElementsByName("introimage[]")[filecount].src = document.getElementsByName("introfiles[]")[filecount].value;
            var reader = new FileReader();
            reader.onload = function (e) {
                // get loaded data and render thumbnail.
                    document.getElementsByName("symptomsimage[]")[filecount].src = e.target.result;
                    document.getElementsByName("symptomsimage[]")[filecount].style.display = "block";
            };
	...
	function deletelifecycleimage(imagepath) {
	    
	    if(document.getElementsByName("lifecycleimagestodelete[]")[0].value == "") {
	        document.getElementsByName("lifecycleimagestodelete[]")[0].value = imagepath;
	    }
	    else {
	        
	        
	        var row = document.getElementsByName("lifecycleimagestodelete[]")[0] // find row to copy
            var clone = row.cloneNode(true); // copy children too
    
            clone.id = "lifecycleimagestodelete[]";
            clone.name = "lifecycleimagestodelete[]";// change id or other attributes/contents
      
	        var deleteimagesdiv = document.getElementById("deleteimages");
	        deleteimagesdiv.appendChild(clone);
	        var len = document.getElementsByName("lifecycleimagestodelete[]").length;
	        document.getElementsByName("lifecycleimagestodelete[]")[len-1].value = imagepath;
    	    
	    }
	    
	     var len1 = document.getElementsByName("leimage").length;
	        for (i=0;i<len1;i++) {
	            if(document.getElementsByName("leimage")[i].src.includes(imagepath.substr(2))) {
	                document.getElementsByName("leimage")[i].style.border = "thick solid Red";
	            }
	        }
	    
	}
	
		function deleteintroimage(imagepath) {
	    
	    if(document.getElementsByName("introimagestodelete[]")[0].value == "") {
	        document.getElementsByName("introimagestodelete[]")[0].value = imagepath;
	    }
	    else {
	        
	        
	        var row = document.getElementsByName("introimagestodelete[]")[0] // find row to copy
            var clone = row.cloneNode(true); // copy children too
    
            clone.id = "introimagestodelete[]";
            clone.name = "introimagestodelete[]";// change id or other attributes/contents
      
	        var deleteimagesdiv = document.getElementById("deleteimages");
	        deleteimagesdiv.appendChild(clone);
	        var len = document.getElementsByName("introimagestodelete[]").length;
	        document.getElementsByName("introimagestodelete[]")[len-1].value = imagepath;
	        
	    }
	    
	    var len1 = document.getElementsByName("introimage").length;
	        for (i=0;i<len1;i++) {
	            if(document.getElementsByName("introimage")[i].src.includes(imagepath.substr(2))) {
	                document.getElementsByName("introimage")[i].style.border = "thick solid Red";
	            }
	        }
	    
	}
	
	function deletesymptomsimage(imagepath) {
	    
	    if(document.getElementsByName("symptomsimagestodelete[]")[0].value == "") {
	        document.getElementsByName("symptomsimagestodelete[]")[0].value = imagepath;
	    }
	    else {
	        
	        
	        var row = document.getElementsByName("symptomsimagestodelete[]")[0] // find row to copy
            var clone = row.cloneNode(true); // copy children too
    
            clone.id = "symptomsimagestodelete[]";
            clone.name = "symptomsimagestodelete[]";// change id or other attributes/contents
      
	        var deleteimagesdiv = document.getElementById("deleteimages");
	        deleteimagesdiv.appendChild(clone);
	        var len = document.getElementsByName("symptomsimagestodelete[]").length;
	        document.getElementsByName("symptomsimagestodelete[]")[len-1].value = imagepath;
    	    
	    }
	    
	    var len1 = document.getElementsByName("symptomsimage").length;
	        for (i=0;i<len1;i++) {
	            if(document.getElementsByName("symptomsimage")[i].src.includes(imagepath.substr(2))) {
	                document.getElementsByName("symptomsimage")[i].style.border = "thick solid Red";
	            }
	        }
