                            ...
                            <div class="card-body">
                                <table class="table table-bordered" id="">
                                    ...
                                    <tbody id="modify-commonnametable">
                                        ...
                                        <DIV id="taxonomy_commonName">
                                            
                                        </DIV>
                                        
                                    </tbody>
                                </table>
                                <input type="button" name="add_item" value="Add More" onClick="addmore_tax_cmn_syn();" />
                                ...
                                <table class="table table-bordered" id="localname">
                                    ...
                                    <tbody id="modify-localnametable">
                                        ...
                                        <tr id="clone-localnamerow[]">
                                            ...
                                            <td>
                                                <input list="localname-name" name="localname_nam[]" id="localname_name[]" class="form-control select2" >
...
<script>
    ...
    //   table.appendChild(clone); // add new row to end of table
      ...
      console.log(document.getElementById(trId));
      var tbid = tbId;
      var tbidFirst = $('#' + tbid).children('tr:first');
      console.log(tbidFirst);
      var clonedRow = tbidFirst.clone();
      //clonedRow.find('input').val('');
      var htmlRow = $(clonedRow).html();
      $('#' + tbid).append(htmlRow);
...
function addmore_tax_cmn_syn() {
	$("<DIV>").load("taxonomy_cmn_syn.php", function() {
			$("#taxonomy_commonName").append($(this).html());
	});	
}
