...
{   
    ...
    $q1 = "update source_entry set resource_name = '$resource_name',title =  '$title',author = '$author',journal = '$journal',issue = '$issue',volume = '$volume', page = '$page',year = '$year',url = '$url',email = '$email' where paper_no = '$paper_no'";
                                ...
                                while(list($introimage)=mysql_fetch_array($rim))
								{
								    ...
								    ?>
								        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-2">
								            <a href = ""><img src="<?php echo $introimage; ?>" alt="Image not Uploaded" height="50" width="50" name="introimage" /></a>
								        </div>
								    <?php
                        ...
                        <label for="exampleInputPassword1">Symptoms</label>
                            <table class="table table-bordered" id="symptoms">
                                ...
                                while(list($symptomsimage)=mysql_fetch_array($r_si))
								{
								    ...
								    ?>
								        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-2">
								            <a href = ""><img src="<?php echo $symptomsimage; ?>" alt="Image not Uploaded" height="50" width="50" name="symptomsimage" /></a>
								        </div>
								    <?php
                ...
                <!--<h3 class="">Life Cycle & Ecology</h3>-->
                        ...
                        <div class="row ">
                                ...
                                while(list($leimage)=mysql_fetch_array($rle))
								{
								    ...
								    ?>
								        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-2">
								            <a href = ""><img src="<?php echo $leimage; ?>" alt="Image not Uploaded" height="50" width="50" name="$leimage" /></a>
								        </div>
								    <?php
