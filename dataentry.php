...
if(isset($_POST['submit_entersource']))
{
    ...
    // echo "<script>alert('$last_modified')</script>";
    
    $crop_result = mysql_query("insert into resource_crop (resource_name) values('$resource_name')");
    
    $q1 = "insert into source_entry(paper_no, 	resource_name, title, author, journal, volume, issue, page, year, publisher, url, email, 	last_modified) 
            values('$paper_no', '$resource_name', '$title', '$author', '$journal', '$volume', '$issue', '$page', '$year', '$publisher', '$url', '$email','$last_modified')";
    ...
    // if($_SESSION['source_entry_id'] == ""){
        
    //     header("location: entersource.php");
    // }
                ...
                <!--<h4>Taxonomy</h4>-->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <INPUT type="button" value="Add Row" onclick="cloneRow('modify-commonnametable','clone-commonnamerow', 'commonname')" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <INPUT type="button" value="Add Row" onclick="cloneRow('modify-localnametable','clone-localnamerow','localname')" />
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-bordered" id="worlddistribution">
                                    ...
                                    <tbody id="modify-worlddistribution">
                                        <tr id="clone-worlddistribution">
                                            ...
                                            <!--</td>-->
                                            <td>
                                                <input type="text"  name="worlddistribution_world[]" id="worlddistribution_autocomplete[]"  class="form-control select2" >
                                ...
                                <table class="table table-bordered" id="indiadistribution">
                                    ...
                                    <tbody id="modify-indiadistribution">
                                        <tr id="clone-indiadistribution">
                                            ...
                                            <!--</td>-->
                                            <td>
                                                <input type="text" name="indiadistribution_states[]" id="indiadistribution_autocomplete[]" class="form-control select2 indiadistribution_autocomplete" >
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <label for="exampleInputPassword1">Symptoms</label>
                            <table class="table table-bordered" id="symptoms">
                                ...
                                <INPUT type="button" value="Add Row" onclick="cloneRow('modify-symptoms','clone-symptoms', 'symptoms')" />
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <label for="exampleInputPassword1">Alternate host</label>
                            <table class="table table-bordered" id="alternatehost">
                                ...
                                <INPUT type="button" value="Add Row" onclick="cloneRow('modify-alternatehost','clone-alternatehost', 'alternatehost')" />
                    </div>
                </div>
                    </div>
                </div>
                ...
                <!--<h3 class="">Prevention & Management</h3>-->
                        ...
                        <div class="row ">
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <textarea rows="2" type="text" name="mechanicalcontrol" id="mechanicalcontrol" class="form-control" > </textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <table class="table table-bordered" id="chemicalcontrol">
                                ...
                                <INPUT type="button" value="Add Row" onclick="cloneRow('modify-chemicalcontrol','clone-chemicalcontrol','chemicalcontrol')" />
                        </div>
                            </div>
                        ...
                        <div class="row">
                            <table class="table table-bordered" id="biologicalcontrol">
                                ...
                                <INPUT type="button" value="Add Row" onclick="cloneRow('modify-biologicalcontrol','clone-biologicalcontrol','biologicalcontrol')" />
                        </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <table class="table table-bordered" id="resistant">
                                ...
                                <INPUT type="button" value="Add Row" onclick="cloneRow('modify-resistant','clone-resistant', 'resistant')" />
                        </div>
                            </div>
                        </div>
              ...
              <div role="tabpanel" class="tab-pane" id="naturalenemies">
                <!--<h3 class="">Natural Enemies</h3>-->
                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="row">
                    <table class="table table-bordered" id="natural_enemies">
                        <thead>
                            <tr>
                    ...
                    <INPUT type="button" value="Add Row" onclick="cloneRow('modify-naturalenemies','clone-naturalenemies','natural_enemies')" />
                    </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-body" >
    	                ...
    	                <div class="box box-default">
    	                    ...
    	                    <div class="box-body">
    	                        ...
    	                        <INPUT type="button" value="Add Row" onclick="cloneRow('modify-synonyms','clone-synonyms','synonyms')" />
    	                    </div>
    	                </div>
                </div>
...
<script>
    ...
    function cloneRow(tbId,trId,tableid) {
...
<script>
       ...
       $(document).ready(function () {    
      var world_input1 = document.getElementsByName('worlddistribution_world[]');;
      var india_input1 = document.getElementsByName('indiadistribution_states[]');
     
      var autocomplete = new google.maps.places.Autocomplete(world_input1[0],
      {
          types: ['(regions)']
      ...
      google.maps.event.addListener(autocomplete, 'place_changed', function () {
        ...
        document.getElementById('worlddistribution_autocomplete').innerHTML = near_place.formatted_address;

        });
        
    
      var autocomplete1 = new google.maps.places.Autocomplete(india_input1[0],{
          types: ['(regions)'],
            componentRestrictions: {country: "in"}
      ...
      google.maps.event.addListener(autocomplete1, 'place_changed', function () {
        ...
        document.getElementById('indiadistribution_autocomplete').innerHTML = near_place1.formatted_address;
