...
if(isset($_POST['submit_dataentry']))
{
    ...
    for($i=0; $i<$india_distribution_count; $i++){
        ...
        $r7 = mysql_query("insert into india_distribution(data_entry_id, india_distribution ) values ($data_entry_id, $india_distribution )");
    }
    ...
    $r8 = mysql_query("insert into introduction	( data_entry_id , introduction, stage_pest_attack,	oviposition_site,	pupation_site,	diapause) values ( '$data_entry_id' , '$introduction', '$stage_pest_attack' ,'$oviposition_site' ,'$pupation_site' ,'$diapause' )");


    $r9 = mysql_query("select max(introduction_id) from introduction");
   ...
   //Introduction_image db code
    ...
    for($i=0; $i<$symptoms_count;$i++){
     ...
     $r11 = mysql_query("select max(symptoms_id) from symptoms");
    ...
    $r13 = mysql_query("insert into life_cycle_ecology (data_entry_id, life_cycle_fc, life_cycle_lc, bio_ecology) values('$data_entry_id', '$life_cycle_fc', '$life_cycle_lc', '$bio_ecology')");
    ...
    $r14 = mysql_query("insert into prevention_manage (data_entry_id, cultural_control, mechanical_control, physical_control, etl) values('$data_entry_id', '$cultural_control', '$mechanical_control', '$physical_control', '$etl')");
    
    
    $r15 = mysql_query("select max(prevention_manage_id) from prevention_manage");
    ...
    $r20 = mysql_query("insert into yield_loss(data_entry_id, yield_loss, economic_loss) values ('$data_entry_id', '$yield_loss', '$economic_loss' )");
    
    
    $additional_info = $_POST['additionalinfo'];
    
    $r21 = mysql_query("insert into additional_info(data_entry_id, additional_info) values ('$data_entry_id', '$additional_info')");
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="admin_settings.php">
            <i class="fa fa-table"></i> <span>Admin Settings</span>
